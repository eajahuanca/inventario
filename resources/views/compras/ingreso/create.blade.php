    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
            <div class="form-group">
                ...
                <input type="checkbox" value="1" name="impuesto" id="impuesto" class="checkbox">13% Impuesto
            </div>
        </div>
    </div>
    <div class="row">
    	...
    	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12" id="guardar">
    		<div class="form-group">
                ...
                <button class="btn btn-primary" type="submit">Generar Comprar</button>
...
<script>
  ...
  function agregar()
  {
    ...
    if (idarticulo!="" && cantidad!="" && cantidad>0 && precio_compra!="" && precio_venta!="")
    {
        ...
        var fila='<tr class="selected" id="fila'+cont+'"><td><input type="hidden" name="idarticulo[]" value="'+idarticulo+'">'+articulo+'</td><td><input type="number" name="cantidad[]" value="'+cantidad+'"></td><td><input type="number" name="precio_compra[]" value="'+precio_compra+'"></td><td><input type="number" name="precio_venta[]" value="'+precio_venta+'"></td><td>'+subtotal[cont]+'</td><td><button type="button" class="btn btn-danger" onclick="eliminar('+cont+');">X</button></td></tr>';
        cont++;
        limpiar();
        $("#total").html("Bs.- " + total);
        evaluar();
    ...
    {
        alert("Bebe ingresar al menos1 1 detalle del ingreso, revise los datos del artículo");
    }
  }
  function limpiar(){
    $("#pcantidad").val("");
