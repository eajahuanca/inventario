...
Route::resource('seguridad/tipo','TipoUsuarioController');



Route::resource('entidad/empresa','EmpresaController');
Route::resource('entidad/sucursal','SucursalController');
Route::resource('entidad/dosificacion','DosificacionController');
Route::get('codigo','FacturaController@codigo');
...
Route::get('reporteusuario', 'UsuarioController@reporte');
