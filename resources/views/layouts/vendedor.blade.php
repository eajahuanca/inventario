  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('home')}}" class="logo">
          ...
          <span class="logo-lg"><b>CompuSystem</b></span>
        </a>
    ...
    <nav class="navbar navbar-static-top">
          ...
          <ul class="sidebar-menu">
            ...
            <li id="liAcceso" class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li id="liRol"><a href="{{url('seguridad/tipo')}}"><i class="fa fa-circle-o"></i> Perfil Usuario</a></li>
              </ul>
            </li>
            ...
            <li id="liEntidad" class="treeview">
              ...
              <ul class="treeview-menu">
                <li id="liDosificacion"><a href="{{url('entidad/dosificacion')}}"><i class="fa fa-circle-o"></i> Dosificacion</a></li>
                <li id="liEmpresa"><a href="{{url('entidad/empresa')}}"><i class="fa fa-circle-o"></i> Empresa</a></li>
                <li id="liSucursal"><a href="{{url('entidad/sucursal')}}"><i class="fa fa-circle-o"></i> Sucursal</a></li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017 <a href="">CompuSystem</a>.</strong> Todo registro reservado.
      </footer>
